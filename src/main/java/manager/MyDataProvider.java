...
public class MyDataProvider {
    ...
    public Iterator<Object[]>dataRegistration(){
        List<Object[]> list = new ArrayList<>();
        list.add(new Object[]{new User().setName("Dorati").setLastName("Doe").setEmail("dor987@mail.com").setPassword("Dd12345$")});
        list.add(new Object[]{new User().setName("Dorati").setLastName("Doe").setEmail("dor768@mail.com").setPassword("Dd12345$")});
        list.add(new Object[]{new User().setName("Dorati").setLastName("Doe").setEmail("dor832@mail.com").setPassword("Dd12345$")});
